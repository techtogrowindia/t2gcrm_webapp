          ...
          {syncResults && (
            <div style={{
              ...
              <div style={{ marginTop: 4 }}>
                ✅ {syncResults.added || 0} added · ⏭ {syncResults.skipped || 0} skipped
                {(syncResults.errors || 0) > 0 ? ` · ❌ ${syncResults.errors} errors` : ''}
                {' '}· 📊 {syncResults.total || 0} total
              </div>

              {/* Compact view: URL + actual API response (skipped when leads were imported) */}
