...
const MODULES = [
  {
    ...
    variables: [
      ...
      { name: '#requirement#',   desc: 'Lead\'s requirement / product interest', example: 'Milking Machine' },
    ...
    example: `Hi #client#, thank you for your enquiry about #requirement#!\nWe received your lead from #source# and will contact you shortly.\n— #bizName#`,
  },
  {
    ...
    example: `Hi #client#, your enquiry for #requirement# has been updated.\nStatus: #fromstage# → #tostage#\nAssigned to: #assignee#`,
  },
  {
    id: 'lead_assigned',
  ...
  },
  {
    ...
    example: `Hi #client#, this is a reminder that your follow-up about #requirement# is scheduled on #followupdate#.\nOur team member #assignee# will connect with you.\n— #bizName#`,
  },
  {
